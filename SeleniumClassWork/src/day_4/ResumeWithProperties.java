...
public class ResumeWithProperties
{
	
	public static void main(String[] args) throws IOException, InterruptedException
	{
        Properties props = new Properties();
        FileInputStream fis = new FileInputStream("C:\\Users\\hp\\Downloads\\personal.properties");
        props.load(fis);
        ...
        String profilePath=props.getProperty("profile.path");
        String loginPath=props.getProperty("login.path");
